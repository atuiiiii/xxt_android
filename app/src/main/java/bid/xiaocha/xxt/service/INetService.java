...
public interface INetService {
    ...
    @GET("/getCollectListByPage")
    Call<GetResultByPage<CollectResult>> getCollectListByPage(@Header("jwt")String jwt , @Query("userId")String userId , @Query("pageNum")int pageNum);
    @GET("/findOneCollect")
    Call<Short> findOneCollect(@Header("jwt")String jwt,@Query("userId")String userId ,@Query("serveId")String serveId);
    @GET("/addOneCollect")
    Call<Short> addOneCollect(@Header("jwt")String jwt,@Query("userId")String userId ,@Query("serveId")String serveId);
    @GET("/deleteOneCollect")
    Call<Short> deleteOneCollect(@Header("jwt")String jwt,@Query("userId")String userId ,@Query("serveId")String serveId);
    @GET("/saveComment")
